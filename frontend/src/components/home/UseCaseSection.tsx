...
import { Heart, AlertTriangle, Shield, Activity, Clock, BarChart3 } from "lucide-react";
...
const UseCaseSection = () => {
  const [currentSelection, setCurrentSelection] = useState("Health Risk Monitoring");
